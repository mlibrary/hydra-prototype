    ...
    protected
      ...
      def build_access(access)
        ...
        self.mode = case access
                    ...
                    when "deposit"
                      Mode.new(DeepBlue::Vocab::ACL.Deposit)
                    when "manage"
                      Mode.new(DeepBlue::Vocab::ACL.Manage)
                    when "intended_reader"
                      Mode.new(DeepBlue::Vocab::ACL.intendedReader)
                    else
...
STDERR.puts "AHOY USING PATCHED HYDRA::ACCESSCONTROLS::PERMISSION"